...
ALTER TABLE bdr_work_information
  ADD CONSTRAINT comp_id_fk FOREIGN KEY (company) REFERENCES bdr_company (id) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT user_id_fk FOREIGN KEY (user) REFERENCES bdr_users (id) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
